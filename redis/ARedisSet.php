...
use yii\liuxy\redis\collections\CList;
...
class ARedisSet extends ARedisIterableEntity {
    ...
    public function random () {
        return $this->getConnection ()->getSlave ()->srandmember ($this->name);
    }
    ...
    public function getCount () {
        if ($this->_count === null) {
            $this->_count = $this->getConnection ()->getSlave ()->scard ($this->name);
        }
        return $this->_count;
    }
    ...
    public function getData ($forceRefresh = false) {
        if ($forceRefresh || $this->_data === null) {
            $this->_data = $this->getConnection ()->getSlave ()->smembers ($this->name);
        }
        return $this->_data;
    }
     ...
     * @throws InvalidConfigException If data is neither an array nor a Traversable.
     */
    public function copyFrom ($data) {
        if (is_array ($data) || ($data instanceof \Traversable)) {
            ...
            throw new InvalidConfigException(Yii::t ('yii' , 'List data must be an array or an object implementing Traversable.'));
    }
    ...
    public function contains ($item) {
        return $this->getConnection ()->getSlave ()->sismember ($this->name , $item);
    }
