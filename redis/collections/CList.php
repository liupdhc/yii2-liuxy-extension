...
class CList extends \yii\base\Component implements \IteratorAggregate , \ArrayAccess , \Countable {
     ...
     * @throws \yii\baseException if the index is out of the range
     */
    public function itemAt ($index) {
        ...
        elseif ($index >= 0 && $index < $this->_c) // in case the value is null
            ...
            throw new Exception(Yii::t ('yii' , 'List index "{index}" is out of bound.' ,
                array('{index}' => $index)));
    }
     ...
     * @param mixed $item new item
     * @throws \yii\base\Exception If the index specified exceeds the bound or the list is read-only
     */
     ...
     * @throws \yii\base\Exception If the item does not exist
     */
     ...
     * @throws \yii\base\Exception If data is neither an array nor an iterator.
     */
