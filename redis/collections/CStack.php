...
class CStack extends Component implements \IteratorAggregate , \Countable {
    /**
     ...
     * @throws \yii\base\Exception If data is not null and neither an array nor an iterator.
     */
     ...
     * @throws \yii\base\Exception If data is neither an array nor a Traversable.
     */
    public function copyFrom ($data) {
        if (is_array ($data) || ($data instanceof \Traversable)) {
            ...
            throw new Exception(\Yii::t ('yii' , 'Stack data must be an array or an object implementing Traversable.'));
    }
     ...
     * @throws \yii\base\Exception if the stack is empty
     */
    public function peek () {
        if ($this->_c)
            return $this->_d[$this->_c - 1];
        else
            throw new Exception(\Yii::t ('yii' , 'The stack is empty.'));
    }
