...
class CQueue extends Component implements \IteratorAggregate , \Countable {
    /**
    ...
    public function copyFrom ($data) {
        if (is_array ($data) || ($data instanceof \Traversable)) {
            ...
            throw new Exception(\Yii::t ('yii' , 'Queue data must be an array or an object implementing Traversable.'));
    }
     ...
     * @throws \yii\base\Exception if the queue is empty
     */
