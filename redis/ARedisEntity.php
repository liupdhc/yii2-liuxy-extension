 ...
 * @author Charles Pick
 */
abstract class ARedisEntity extends Behavior {
	/**
	 ...
	 * @throws InvalidConfigException if no name is set
	 * @param \yii\base\Component $owner the owner component
	 */
	public function attach($owner) {
		parent::attach($owner);
		if ($this->name === null) {
			throw new InvalidConfigException("No name specified for ".get_class($this));
		}
