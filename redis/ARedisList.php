...
class ARedisList extends ARedisIterableEntity {
    ...
    public function range ($start = 0 , $stop = -1) {
        ...
        return $this->getConnection ()->getSlave ()->lrange ($this->name , $start , $stop);
    }
    ...
    public function trim ($start , $stop) {
        ...
        return $this->getConnection ()->getSlave ()->ltrim ($this->name , $start , $stop) ? true : false;
    }
    ...
    public function getCount () {
        if ($this->_count === null) {
            ...
            $this->_count = (int)$this->getConnection ()->getSlave ()->lSize ($this->name);
        }
        return $this->_count;
    }
